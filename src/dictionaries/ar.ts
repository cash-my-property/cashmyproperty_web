export const content = {
  ...
  about: {
    hero: {
      tagline: "قصتنا",
      title: "رؤية\nوتميز.",
      description: "نحدث نقلة نوعية في المشهد العقاري في دبي وجميع أنحاء الإمارات."
    },
    main: {
      label: "عن Cash My Property",
      heading: "أبرز منصة للمزادات العقارية الرقمية في الإمارات",
      paragraphs: [
        "تأسست Cash My Property على مبادئ الشفافية والكفاءة والابتكار، وهي تعيد تعريف كيفية بيع وشراء العقارات في الإمارات.",
        "نحن نوفر منصة آمنة ومشفرة تربط البائعين المعتمدين بالمشترين المؤهلين. تقضي مزاداتنا الرقمية على فوضى القوائم التقليدية، مما يضمن أن كل عقار يتم تداوله على منصتنا حقيقي ومرتبط برقم BRN فعلي، ومطابق للوائح دائرة الأراضي والأملاك."
      ],
      features: [
        {
          title: "الشفافية",
          description: "عمليات مزايدة واضحة بدون رسوم خفية أو إعلانات مسروقة."
        },
        {
          title: "الأمان",
          description: "معاملات مشفرة بالكامل ومشاركون معتمدون."
        }
      ],
      joinButton: "انضم إلى المنصة",
