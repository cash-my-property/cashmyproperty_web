  ...
  return (
    <main className="flex-1 flex flex-col bg-gray-50 dark:bg-[#0F172A] transition-colors min-h-screen">
      ...
      <section className="relative w-full h-[350px] sm:h-[450px] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[#1B3A2D]/80 dark:bg-[#0F172A]/90 mix-blend-multiply" />
      ...
      <section className="py-16 sm:py-24 px-6 lg:px-12 w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {content.blog.main.posts.map((post) => (
            <Link key={post.id} href="#" className="group flex flex-col bg-white dark:bg-[#1E293B] rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.2)] border border-gray-100 dark:border-slate-800 hover:-translate-y-1 transition-all duration-300">
              {/* Fake image placeholder for the blog card */}
              <div className="w-full h-[240px] bg-gray-200 dark:bg-slate-700 relative overflow-hidden">
                <div 
                ...
                <div className="absolute top-4 left-4">
                  <span className="text-[11px] font-bold tracking-wider uppercase text-[#1A3626] dark:text-white bg-white/90 dark:bg-[#5CD284] backdrop-blur-md px-3 py-1.5 rounded-full shadow-sm">
                    {post.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-2 text-[14px] font-bold text-[#1A3626] dark:text-[#5CD284] group-hover:gap-3 transition-all mt-auto pt-4 border-t border-gray-100 dark:border-slate-800">
