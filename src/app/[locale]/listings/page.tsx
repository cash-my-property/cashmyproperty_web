      ...
      <section className="relative w-full pt-36 sm:pt-40 pb-16 px-6 lg:px-12 flex flex-col items-center justify-center overflow-hidden bg-[#1B3A2D] dark:bg-[#0A1612]">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto flex flex-col items-center mt-8">
          ...
          <div className="w-full max-w-4xl bg-white dark:bg-[#1E293B] p-2 rounded-2xl shadow-2xl flex flex-col sm:flex-row gap-2 border border-gray-100 dark:border-slate-700">
            ...
            <div className="hidden md:flex items-center gap-3 px-4 py-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl cursor-pointer group">
            ...
            <button className="bg-[#1A3626] dark:bg-[#5CD284] text-white dark:text-[#1A3626] px-8 py-3 rounded-xl font-bold text-[14px] hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4 flex gap-3 overflow-x-auto global-green-scrollbar">
          {["All", "Villa", "Apartment", "Penthouse", "Townhouse", "Commercial"].map((type) => (
            <button 
              ...
              className={`whitespace-nowrap px-5 py-2 rounded-full text-[14px] font-bold transition-all duration-300 ${activeType === type ? 'bg-[#1A3626] text-white dark:bg-[#5CD284] dark:text-[#1A3626] shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-slate-800 dark:text-gray-300 dark:hover:bg-slate-700'}`}
            >
              {type}
            </button>
          ))}
