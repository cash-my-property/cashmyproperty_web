...
export const metadata: Metadata = {
  title: "Verified Real Estate Brokers | CMP Dubai",
  description: "Find and connect with RERA-licensed real estate agents, agencies, and verified property brokers across Dubai & UAE.",
  keywords: [
    "Verified Real Estate Brokers Dubai",
    "RERA Licensed Agents",
    "Dubai Real Estate Agencies",
    "CMP Verified Brokers",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "CMP Verified Brokers Directory",
      },
    ],
    locale: "en_US",
    type: "website",
