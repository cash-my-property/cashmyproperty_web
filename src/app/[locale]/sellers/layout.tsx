...
export const metadata: Metadata = {
  title: "Verified Real Estate Agents | CMP Dubai",
  description: "Find and connect with RERA-licensed real estate agents, agencies, and verified property owners across Dubai & UAE.",
  keywords: [
    "Verified Real Estate Agents Dubai",
    "RERA Licensed Agents",
    "Dubai Real Estate Agencies",
    "CMP Verified Agents",
    "Dubai Property Agents",
    "Agency Directory UAE"
  ],
  openGraph: {
    title: "Verified Real Estate Agents | CMP Dubai",
    description: "Find and connect with RERA-licensed real estate agents, agencies, and verified property owners across Dubai & UAE.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "CMP Verified Agents Directory",
      },
    ],
    locale: "en_US",
    type: "website",
