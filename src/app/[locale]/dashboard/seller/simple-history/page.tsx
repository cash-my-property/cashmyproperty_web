  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        let url = `/seller/simpleListingHistory?page=${currentPage}&limit=10&sortBy=${sortBy}`;
        if (statusFilter !== "all") {
                ...
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <div className="flex items-center gap-2 pt-4 border-t border-gray-100 dark:border-[#1A3626] mt-auto">
                    <button 
                      ...
                      className="w-full py-2 text-sm font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#163321] rounded-lg transition-colors flex items-center justify-center gap-2 cursor-pointer"
                    >
